...
// IF THERE ARE NO EMPTY FIELDS THEN-
   ...
   // $profile = $data->make_avatar(strtoupper($_POST['user_name'][0]));
    $status='Disabled';
    ...
    elseif (strlen($name) < 3) :
        ...
        try {
            ...
            if ($check_email_stmt->rowCount()) :
                ...
                $insert_query = "INSERT INTO `chat_user_table` (`user_name`,`user_email`,`user_password`,`user_status`,`user_created_on`,`user_verification_code`) VALUES(:name,:email,:password,:user_status,:user_created_on,:user_verification_code)";
